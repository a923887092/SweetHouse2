 ...
 */
public class BeautPicProtocal extends BaseProtocol<ArrayList<BeautifulPic>> {
    private static final String TAG = "BeautPicProtocal";
    private String mCache;
    public BeautPicProtocal(String url,String mCache) {
        super(url);
        this.mCache = mCache;
    }
